...
const list = [
  { text: "i~&^^", code: "\u0434", name: 'Nasal German i with extra high tone' },
  { text: "i~&^", code: "\u0434", name: 'Nasal German i with high tone' },
  { text: "i~&__", code: "\u0438", name: 'Nasal German i with extra low tone' },
  { text: "i~&_", code: "\u0438", name: 'Nasal German i with low tone' },
  { text: "i~&", code: "\u0430", name: 'Nasal German i' },
  { text: "(i~&^^)", code: "\u0435", name: 'Nasal German i with extra high tone and stress' },
  { text: "(i~&^)", code: "\u0435", name: 'Nasal German i with high tone and stress' },
  { text: "(i~&__)", code: "\u0439", name: 'Nasal German i with extra low tone and stress' },
  { text: "(i~&_)", code: "\u0439", name: 'Nasal German i with low tone and stress' },
  { text: "(i~&)", code: "\u0432", name: 'Nasal German i with stress' },

  { text: "i~^^", code: "\u0434", name: 'German i with extra high tone' },
  { text: "i~^", code: "\u0434", name: 'German i with high tone' },
  { text: "i~__", code: "\u0438", name: 'German i with extra low tone' },
  { text: "i~_", code: "\u0438", name: 'German i with low tone' },
  { text: "i~", code: "\u0430", name: 'German i' },
  { text: "(i~^^)", code: "\u0435", name: 'German i with extra high tone and stress' },
  { text: "(i~^)", code: "\u0435", name: 'German i with high tone and stress' },
  { text: "(i~__)", code: "\u0439", name: 'German i with extra low tone and stress' },
  { text: "(i~_)", code: "\u0439", name: 'German i with low tone and stress' },
  { text: "(i~)", code: "\u0432", name: 'German i with stress' },

  { text: "i+&^^", code: "\u03d4", name: 'Nasal short i with extra high tone' },
  { text: "i+&^", code: "\u03d4", name: 'Nasal short i with high tone' },
  { text: "i+&__", code: "\u03d8", name: 'Nasal short i with extra low tone' },
  { text: "i+&_", code: "\u03d8", name: 'Nasal short i with low tone' },
  { text: "i+&", code: "\u03d0", name: 'Nasal short i' },
  { text: "(i+&^^)", code: "\u03d5", name: 'Nasal short i with extra high tone and stress' },
  { text: "(i+&^)", code: "\u03d5", name: 'Nasal short i with high tone and stress' },
  { text: "(i+&__)", code: "\u03d9", name: 'Nasal short i with extra low tone and stress' },
  { text: "(i+&_)", code: "\u03d9", name: 'Nasal short i with low tone and stress' },
  { text: "(i+&)", code: "\u03d2", name: 'Nasal short i with stress' },

  { text: "i+^^", code: "\u03d4", name: 'Short i with extra high tone' },
  { text: "i+^", code: "\u03d4", name: 'Short i with high tone' },
  { text: "i+__", code: "\u03d8", name: 'Short i with extra low tone' },
  { text: "i+_", code: "\u03d8", name: 'Short i with low tone' },
  { text: "i+", code: "\u03d0", name: 'Short i' },
  { text: "(i+^^)", code: "\u03d5", name: 'Short i with extra high tone and stress' },
  { text: "(i+^)", code: "\u03d5", name: 'Short i with high tone and stress' },
  { text: "(i+__)", code: "\u03d9", name: 'Short i with extra low tone and stress' },
  { text: "(i+_)", code: "\u03d9", name: 'Short i with low tone and stress' },
  { text: "(i+)", code: "\u03d2", name: 'Short i with stress' },

  { text: "i&^^", code: "\u0474", name: 'Nasal i sound with extra high tone' },
  { text: "i&^", code: "\u0474", name: 'Nasal i sound with high tone' },
  { text: "i&__", code: "\u0478", name: 'Nasal i sound with extra low tone' },
  { text: "i&_", code: "\u0478", name: 'Nasal i sound with low tone' },
  { text: "i&", code: "\u0470", name: 'Nasal i sound' },
  { text: "(i&^^)", code: "\u0475", name: 'Nasal i sound with extra high tone and stress' },
  { text: "(i&^)", code: "\u0475", name: 'Nasal i sound with high tone and stress' },
  { text: "(i&__)", code: "\u0479", name: 'Nasal i sound with extra low tone and stress' },
  { text: "(i&_)", code: "\u0479", name: 'Nasal i sound with low tone and stress' },
  { text: "(i&)", code: "\u0472", name: 'Nasal i sound with stress' },

  { text: "i^^", code: "\u0474", name: 'I sound with extra high tone' },
  { text: "i^", code: "\u0474", name: 'I sound with high tone' },
  { text: "i__", code: "\u0478", name: 'I sound with extra low tone' },
  { text: "i_", code: "\u0478", name: 'I sound with low tone' },
  { text: "i", code: "\u0470", name: 'I sound' },
  { text: "(i^^)", code: "\u0475", name: 'I sound with extra high tone and stress' },
  { text: "(i^)", code: "\u0475", name: 'I sound with high tone and stress' },
  { text: "(i__)", code: "\u0479", name: 'I sound with extra low tone and stress' },
  { text: "(i_)", code: "\u0479", name: 'I sound with low tone and stress' },
  { text: "(i)", code: "\u0472", name: 'I sound with stress' },

  { text: "e~&^^", code: "\u0456", name: 'Nasal Danish oe with extra high tone' },
  { text: "e~&^", code: "\u0456", name: 'Nasal Danish oe with high tone' },
  { text: "e~&__", code: "\u045a", name: 'Nasal Danish oe with extra low tone' },
  { text: "e~&_", code: "\u045a", name: 'Nasal Danish oe with low tone' },
  { text: "e~&", code: "\u0451", name: 'Nasal Danish oe' },
  { text: "(e~&^^)", code: "\u0457", name: 'Nasal Danish oe with extra high tone and stress' },
  { text: "(e~&^)", code: "\u0457", name: 'Nasal Danish oe with high tone and stress' },
  { text: "(e~&__)", code: "\u045b", name: 'Nasal Danish oe with extra low tone and stress' },
  { text: "(e~&_)", code: "\u045b", name: 'Nasal Danish oe with low tone and stress' },
  { text: "(e~&)", code: "\u0453", name: 'Nasal Danish oe with stress' },

  { text: "e~^^", code: "\u0456", name: 'Danish oe with extra high tone' },
  { text: "e~^", code: "\u0456", name: 'Danish oe with high tone' },
  { text: "e~__", code: "\u045a", name: 'Danish oe with extra low tone' },
  { text: "e~_", code: "\u045a", name: 'Danish oe with low tone' },
  { text: "e~", code: "\u0451", name: 'Danish oe' },
  { text: "(e~^^)", code: "\u0457", name: 'Danish oe with extra high tone and stress' },
  { text: "(e~^)", code: "\u0457", name: 'Danish oe with high tone and stress' },
  { text: "(e~__)", code: "\u045b", name: 'Danish oe with extra low tone and stress' },
  { text: "(e~_)", code: "\u045b", name: 'Danish oe with low tone and stress' },
  { text: "(e~)", code: "\u0453", name: 'Danish oe with stress' },

  { text: "e+&^^", code: "\u0454", name: 'Nasal short e with extra high tone' },
  { text: "e+&^", code: "\u0454", name: 'Nasal short e with high tone' },
  { text: "e+&__", code: "\u0458", name: 'Nasal short e with extra low tone' },
  { text: "e+&_", code: "\u0458", name: 'Nasal short e with low tone' },
  { text: "e+&", code: "\u0450", name: 'Nasal short e' },
  { text: "(e+&^^)", code: "\u0455", name: 'Nasal short e with extra high tone and stress' },
  { text: "(e+&^)", code: "\u0455", name: 'Nasal short e with high tone and stress' },
  { text: "(e+&__)", code: "\u0459", name: 'Nasal short e with extra low tone and stress' },
  { text: "(e+&_)", code: "\u0459", name: 'Nasal short e with low tone and stress' },
  { text: "(e+&)", code: "\u0452", name: 'Nasal short e with stress' },

  { text: "e+^^", code: "\u0454", name: 'Short e with extra high tone' },
  { text: "e+^", code: "\u0454", name: 'Short e with high tone' },
  { text: "e+__", code: "\u0458", name: 'Short e with extra low tone' },
  { text: "e+_", code: "\u0458", name: 'Short e with low tone' },
  { text: "e+", code: "\u0450", name: 'Short e' },
  { text: "(e+^^)", code: "\u0455", name: 'Short e with extra high tone and stress' },
  { text: "(e+^)", code: "\u0455", name: 'Short e with high tone and stress' },
  { text: "(e+__)", code: "\u0459", name: 'Short e with extra low tone and stress' },
  { text: "(e+_)", code: "\u0459", name: 'Short e with low tone and stress' },
  { text: "(e+)", code: "\u0452", name: 'Short e with stress' },

  { text: "e&^^", code: "\u0414", name: 'Nasal e sound with extra high tone' },
  { text: "e&^", code: "\u0414", name: 'Nasal e sound with high tone' },
  { text: "e&__", code: "\u0418", name: 'Nasal e sound with extra low tone' },
  { text: "e&_", code: "\u0418", name: 'Nasal e sound with low tone' },
  { text: "e&", code: "\u0410", name: 'Nasal e sound' },
  { text: "(e&^^)", code: "\u0415", name: 'Nasal e sound with extra high tone and stress' },
  { text: "(e&^)", code: "\u0415", name: 'Nasal e sound with high tone and stress' },
  { text: "(e&__)", code: "\u0419", name: 'Nasal e sound with extra low tone and stress' },
  { text: "(e&_)", code: "\u0419", name: 'Nasal e sound with low tone and stress' },
  { text: "(e&)", code: "\u0412", name: 'Nasal e sound with stress' },

  { text: "e^^", code: "\u0414", name: 'E sound with extra high tone' },
  { text: "e^", code: "\u0414", name: 'E sound with high tone' },
  { text: "e__", code: "\u0418", name: 'E sound with extra low tone' },
  { text: "e_", code: "\u0418", name: 'E sound with low tone' },
  { text: "e", code: "\u0410", name: 'E sound' },
  { text: "(e^^)", code: "\u0415", name: 'E sound with extra high tone and stress' },
  { text: "(e^)", code: "\u0415", name: 'E sound with high tone and stress' },
  { text: "(e__)", code: "\u0419", name: 'E sound with extra low tone and stress' },
